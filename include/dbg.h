...
#define log_err(MSG) fprintf(stderr, TERM_RED "[ERROR]" TERM_COLOR_X " (%s:%d:%s, errno: %s) %s\n", __FILE__, __LINE__, __func__, clean_errno(), MSG)
 
#define log_warn(MSG) fprintf(stderr, TERM_YELLOW "[WARN]" TERM_COLOR_X " (%s:%d:%s, errno: %s) %s\n", __FILE__, __LINE__, __func__, clean_errno(), MSG)
 
#define log_info(MSG) fprintf(stderr, TERM_WHITE "[INFO]" TERM_COLOR_X " (%s:%d:%s) %s\n", __FILE__, __LINE__, __func__, MSG)
